...
def move_pov_down():
    ...
    if game_stats.cur_level_height + game_stats.pov_pos[1] < 12:
        game_stats.pov_pos[1] += 1
        update_gf_game_board.update_sprites()
        print("new pov_pos - " + str(game_stats.pov_pos))
...
def move_pov_right():
    ...
    if game_stats.cur_level_width + game_stats.pov_pos[0] < 6:
        game_stats.pov_pos[0] += 1
        update_gf_game_board.update_sprites()
        print("new pov_pos - " + str(game_stats.pov_pos))
