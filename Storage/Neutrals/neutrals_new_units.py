...
def create_simurg_anarchists():
    new_unit = Regiment("Simurg's anarchists", 4,  # name, rank
...
def create_bandit_archers():
    new_unit = Regiment("Bandit archers", 4,  # name, rank
                        "bandit_archers",  # img
...
def create_highway_robbers():
    new_unit = Regiment("Highway robbers", 6,  # name, rank
                        "highway_robbers",  # img
...
def create_robber_knights():
    new_unit = Regiment("Robber knights", 10,  # name, rank
                        "robber_knights",  # img
...
def create_grey_dragon():
    new_unit = Regiment("Grey dragon", 20,  # name, rank
                        "grey_dragon",  # img
...
def create_grey_drakes():
    new_unit = Regiment("Grey drakes", 15,  # name, rank
                        "grey_drakes",  # img
