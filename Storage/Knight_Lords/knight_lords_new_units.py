...
def create_peasant_mob():
    new_unit = game_classes.Regiment("Peasant mob", 3,  # name, rank
                                     "peasant_mob",  # img
...
def create_peasant_bowmen():
    new_unit = game_classes.Regiment("Peasant bowmen", 3,  # name, rank
                                     "peasant_bowmen",  # img
                                     ...
                                     create_unit.fill_with_creatures(5, 4, creature_dict, "Peasant bowmen"),
                                     # creatures
                                     [game_classes.Strike("Melee assault", "Melee",
                                                          ["Melee", "Physical"],
...
def create_crossbowmen():
    new_unit = game_classes.Regiment("Crossbowmen", 5,  # name, rank
                                     "crossbowmen",  # img
                                     ...
                                     create_unit.fill_with_creatures(5, 4, creature_dict, "Crossbowmen"),  # creatures
                                     [game_classes.Strike("Melee assault", "Melee",
                                                          ["Melee", "Physical"],
...
def create_spear_footmen():
    new_unit = game_classes.Regiment("Spear footmen", 6,  # name, rank
                                     "spear_footmen",  # img
...
def create_sword_footmen():
    new_unit = game_classes.Regiment("Sword footmen", 6,  # name, rank
                                     "sword_footmen",  # img
...
def create_squires():
    new_unit = game_classes.Regiment("Squires", 7,  # name, rank
                                     "squires",  # img
                                     "KL", 16, 14, 6,  # img_source, x_offset, y_offset, speed
...
def create_knights():
    new_unit = game_classes.Regiment("Knights", 10,  # name, rank
                                     "knights",  # img
...
def create_priests_of_salvation():
    new_unit = game_classes.Regiment("Priests of Salvation", 6,  # name, rank
                                     ...
                                     8, 16, 4, 4, 4,
                                     ["caster"],
                                     create_unit.fill_with_creatures(4, 4, creature_dict, "Priests of Salvation"),
                                     # creatures
                                     [game_classes.Strike("Melee assault", "Melee",
                                                          ["Melee", "Physical"],
...
def create_battle_monks():
    new_unit = game_classes.Regiment("Battle monks", 8,  # name, rank
                                     "battle_monks",  # img
                                     ...
                                     create_unit.fill_with_creatures(4, 4, creature_dict, "Battle monks"),  # creatures
                                     [game_classes.Strike("Melee assault", "Melee",
                                                          ["Melee", "Physical"],
...
def create_griffons():
    new_unit = game_classes.Regiment("Griffons", 9,  # name, rank
                                     "griffons",  # img
                                     ...
                                     20, 0, 0, 4, 2,
                                     ["melee", "monster"],
                                     create_unit.fill_with_creatures(4, 2, creature_dict, "Griffons"),  # creatures
                                     [game_classes.Strike("Melee assault", "Melee",
                                                          ["Melee", "Physical"],
...
def create_pegasus_knights():
    new_unit = game_classes.Regiment("Pegasus knights", 10,  # name, rank
                                     "pegasus_knights",  # img
                                     ...
                                     16, 0, 0, 4, 2,
                                     ["melee", "melee cavalry"],
                                     create_unit.fill_with_creatures(4, 2, creature_dict, "Pegasus knights"),
                                     # creatures
                                     [game_classes.Strike("Melee assault", "Melee",
                                                          ["Melee", "Physical"],
...
def create_field_ballistas():
    new_unit = game_classes.Regiment("Field ballistas", 10,  # name, rank
                                     "field_ballistas",  # img
                                     ...
                                     25, 0, 0, 2, 2,
                                     ["ranged", "machines"],
                                     create_unit.fill_with_creatures(2, 2, creature_dict, "Field ballistas"),
                                     # creatures
                                     [game_classes.Strike("Melee assault", "Melee",
                                                          ["Melee", "Physical"],
