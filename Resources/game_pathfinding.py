                ...
                if TileObj.army_id is not None:
                        ...
                        for army in game_obj.game_armies:
                            if army.army_id == TileObj.army_id:
                                if army.owner == army_owner:
                                    ...
                                    route = algo_astar.astar(selected_army, start, tile_position, "Own army")

                                else:
                                    print("Moving toward someone else's army")
                                    route = algo_astar.astar(selected_army, start, tile_position, "Other's army")
                    ...
                    if TileObj.lot == "Settlement":
                        ...
                        if TileObj.travel:
                            ...
                            route = algo_astar.astar(selected_army, start, tile_position, "Empty")
                        ...
                        route = algo_astar.astar(selected_army, start, tile_position, "Facility")
